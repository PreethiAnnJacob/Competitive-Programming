...
int main()
{
    long long int n,w=1,i=1,j=1,a[50][50],next;
    scanf("%lld",&n);
    for(i=1;i<=n;i++)
        for(j=1;j<=n;j++)
            scanf("%lld",&a[i][j]);
    i=1;j=1;printf("(%lld,%lld) ",i,j);
    do
    {   if(i+1>n)
        {   next=a[i][j+1];
            j=j+1;
...
2 18 28 22
14 25 4 13
(1,1) (1,2) (2,2) (2,3) (2,4) (3,4) (4,4) Minimum weight=22
Process returned 0 (0x0)   execution time : 32.348 s
Press any key to continue.
*/
/*
5 1 29 40 24 12 13 31 40 31 33 29 40 17 35 32 15 39 28 3 31 15 21 31 38 24
(1,1) (2,1) (3,1) (4,1) (5,1) (5,2) (5,3) (5,4) (5,5) Minimum weight=38
Process returned 0 (0x0)   execution time : 40.559 s
Press any key to continue.
