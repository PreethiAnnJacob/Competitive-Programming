...
Given an integer, we need to find the super difit of the integer.
  If x has only 1 digit, then its super digit is x.
  Otherwise, the superdigit of x is equal to the super digit of the sum of the digits of x.
...
# Doesn't work for 3 testcases: Says Runtime Error : Score 66.67
# If mod 9 is removed also, same 3 testcases doesn't work
# def superDigit(n, k): 
